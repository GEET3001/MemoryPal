...
export function SharedNote() {
    ...
    useEffect(() => {
        ...
        if (!token) {
            alert("Please sign in to view this note.");
            navigate("/signin");
            return;
        }
    ...
    if (error) return (
        <div className="h-screen w-screen flex flex-col items-center justify-center bg-gray-50 px-6 text-center">
            ...
            <p className="text-gray-500 max-w-md">The note you are looking for might have been deleted or the link is invalid.</p>
            <a href="/dashboard" className="mt-8 text-purple-600 font-bold hover:underline">Go to My Dashboard</a>
        </div>
    );
        ...
        <div className="min-h-screen bg-white">
            ...
            <main className="max-w-4xl mx-auto px-6 py-16 md:py-24">
                    ...
                    <div className="flex flex-wrap gap-3">
                        {note.links.map((l: string, i: number) => (
                            ...
                            >
                                ...
                                Reference {note.links.length > 1 ? i + 1 : ""}
                            </a>
                        ))}
                    </div>
                </header>
                ...
                <footer className="mt-24 pt-12 border-t border-gray-50 text-center">
                    ...
                    <button onClick={() => navigate("/dashboard")} className="inline-block bg-purple-600 text-white px-8 py-4 rounded-2xl font-black shadow-xl shadow-purple-100 hover:scale-105 transition-transform">
