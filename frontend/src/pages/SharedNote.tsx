    ...
    if (error) return (
        <div className="h-screen w-screen flex flex-col items-center justify-center bg-gray-50 px-6 text-center">
            ...
            {isLoggedIn ? (
                ...
                <button onClick={() => navigate("/signup")} className="mt-8 text-purple-600 font-bold hover:underline">
            ...
            <nav className="border-b border-gray-50 py-6 px-8 flex justify-between items-center">
                ...
                {isLoggedIn ? (
                    ...
                    <button
                        ...
                        className="px-5 py-2.5 bg-purple-600 text-white rounded-xl font-bold text-sm hover:bg-purple-700 transition-all"
                    >
                        Get MemoryPal
                    </button>
                )}
